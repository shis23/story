...
当前执行计划见 `docs/ROADMAP.md`；Campaign 主线已归档到 `docs/archive/2026-06-19-completed-phases/PLAN-CAMPAIGN-MAINLINE.md`；角色统一历史计划已归档到 `docs/archive/2026-06-17-campaign-mainline-phase5/PLAN-CHARACTER-UNIFICATION.md`。
