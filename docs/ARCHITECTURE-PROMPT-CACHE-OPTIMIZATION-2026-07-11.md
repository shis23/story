...
> | C | **M0–M4.2 可独立部分** | history-epoch + prompt catalog；near_raw；A/B/C tools；Turn 只计 A；Compressor claim + **Pending Accept 重试** + **pending_compress_publication marker** | M5 真模型；UnitOfWork/SQLite |
