...
> | C | **M0–M4.2.2 可独立部分** | history-epoch + prompt catalog；near_raw；A/B/C tools；Turn 只计 A；Compressor + **epoch refresh 同 Campaign 锁** + marker 校验 | M5 真模型；UnitOfWork/SQLite |
