...
> | C | **M0–M4.2.1 可独立部分** | history-epoch + prompt catalog；near_raw；A/B/C tools；Turn 只计 A；Compressor claim + Pending Accept 重试 + **锁内 publish/heal + marker 校验** | M5 真模型；UnitOfWork/SQLite |
